...
//        @NamedQuery(name = Meal.GET_BETWEEN, query = "SELECT m FROM Meal m WHERE m.dateTime between :startDate AND " +
//                ":endDate AND m.user.id=:userId ORDER BY m.dateTime DESC")
})
@Entity
